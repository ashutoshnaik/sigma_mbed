...
#define CH_WSM_FLAG_UNITS_LBS                 0x00    /* Weight in units of pounds */
#define CH_WSM_FLAG_UNITS_KG                  0x01    /* Weight in units of kilograms */
#define CH_WSM_FLAG_TIMESTAMP                 0x02    /* Time Stamp Flag */

/* Weight Scale Measurement field lengths */
#define CH_WSM_FLAGS_LEN                      1
#define CH_WSM_MEAS_LEN                       4
